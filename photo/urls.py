...
urlpatterns = [
    ...
    path('album/<int:pk>/delete/',
        views.AlbumDelV.as_view(), name="album_delete"
    ),

    # Example: /photo/photo/add/
    path('photo/add/',
         views.PhotoCV.as_view(), name="photo_add",
    ),

    # Example: /photo/photo/change/
    path('photo/change/',
        views.PhotoChangeLV.as_view(), name="photo_change",
    ),

    # Example: /photo/photo/99/update/
    path('photo/<int:pk>/update/',
        views.PhotoUV.as_view(), name="photo_update"
    ),

    # Example: /photo/album/99/delete/
    path('photo/<int:pk>/delete/',
        views.PhotoDelV.as_view(), name="photo_delete"
    ),
]