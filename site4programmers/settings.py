"""
Django settings for site4programmers project.
...
from .key_manage import get_secret_key
...
ROOT_URLCONF = 'site4programmers.urls'
...
WSGI_APPLICATION = 'site4programmers.wsgi.application'
